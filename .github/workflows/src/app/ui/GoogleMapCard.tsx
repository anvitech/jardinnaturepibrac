export default function GoogleMapCard({title}: Readonly<{title?: string}>) {
  return (
    <div className="w-full h-96 justify-center mt-8">
      {title &&<h3 className="text-green-600 mb-4">{title}</h3>}
      <iframe
